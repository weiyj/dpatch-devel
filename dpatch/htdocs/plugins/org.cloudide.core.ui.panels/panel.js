        ...
        function Panel(developer, deps, options) {
            ...
            plugin.on("load", function(){
                ...
                settings.on("read", function(){
                    ...
                    // Activate Panel
                    ["left", "right", "top", "bottom"].forEach(function(where) {
            ...
            function draw(){
                ...
                aml.$ext.style.minHeight = ""; //Needed for the anims
                aml.$ext.style.position = "absolute";
                aml.$ext.style.left = where == "left" ? area.width + "px" : 0;
                aml.$ext.style.top = where == "top" ? area.width + "px" : 0;
                aml.$ext.style.right = where == "right" ? area.width + "px" : 0;
                aml.$ext.style.bottom = where == "bottom" ? area.width + "px" : 0;
            ...
            plugin.freezePublicAPI({
                ...
                /**
                 * Retrieves the minimal height in pixels of this panel
