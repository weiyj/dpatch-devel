define(function(require, exports, module) {
    ...
    function main(options, imports, register) {
        ...
        function load(){
            ...
            areas.top = new Area("top", options.defaultActiveTop, plugin, emit);
            areas.bottom = new Area("bottom", options.defaultActiveBottom, plugin, emit);
        ...
        function isActive(name) {
            return areas.left.activePanel == name
                ...
                || areas.top.activePanel == name
                || areas.bottom.activePanel == name;
        }
        ...
        plugin.freezePublicAPI({
            ...
            get activePanels(){
                ...
                if (areas.top.activePanel)
                    panels.push(areas.top.activePanel);
                if (areas.bottom.activePanel)
                    panels.push(areas.bottom.activePanel);
                return panels;
            },
