define(function(require, module, exports) {
    ...
    function main(options, imports, register) {
        ...
        var uCaseFirst = require("string").uCaseFirst;
        ...
        function Area(where, defaultActive, panels, emit) {
            ...
            function draw(){
                ...
                splitter.on("dragdrop", function(e) {
                    ...
                    var width;
                    if (where == "left" || where == "right") {
                        width = column.getWidth() - CURWIDTH;
                    } else {
                        width = column.getHeight() - CURWIDTH;
                    }
            ...
            function animate(fromName, toName, toWidth, noAnim) {
                ...
                if (where == "left" || where == "right") {
                    ...
                    column.setAttribute("minHeight", CURWIDTH);
                }
                    ...
                    setTimeout(function(){
                        ...
                        if (toWin) {
                            ...
                            if (where == "left" || where == "right") {
                                ...
                                toWinExt.style.minHeight = "";
                                toWinExt.style.maxHeight = "";
                            }

                            if (where == "right") {
                                toWinExt.style.left = "0";
                            } else if (where == "top") {
                                toWinExt.style.top = "0";
                            }
                ...
                if (win) {
                    ...
                    if (toWin) {
                        ...
                        if (autohide) {
                            ...
                            if (where == "left" || where == "right") {
                                ...
                                diff = apf.getHeightDiff(winExt);
                                width = winExt.offsetHeight - diff;
                                winExt.style.minHeight = width + "px";
                                winExt.style.maxHeight = width + "px";
                            }
                            if (where == "right")
                                winExt.style.left = "";
                            ...
                            if (where == "left" || where == "right") {
                                ...
                                anim[where] = (CURWIDTH - win.getHeight() - 1) + "px";
                            }
                        ...
                        // Show over the other
                            ...
                            if (where == "left" || where == "right") {
                                ...
                                toWinExt.style[where] = (CURWIDTH - win.getHeight()) + "px";
                            }
                    ...
                    // Hide
                        ...
                        if (where == "left" || where == "right") {
                            ...
                            winExt.style.minHeight = (winExt.offsetHeight - apf.getHeightDiff(winExt)) + "px";
                            anim.height = CURWIDTH + "px";
                        }
                ...
                // Show
                    ...
                    if (where == "left" || where == "right") {
                        ...
                        toWinExt.style.minHeight = (toWidth - apf.getHeightDiff(toWinExt) - CURWIDTH) + "px";
                        anim.height = toWidth + "px";
                    }
                    toWinExt.style[where] = ""; //CURWIDTH + "px";
                    anims.animateSplitBoxNode(column, anim, onfinish);
                }
            ...
            function activate(name, noAnim, viaButton) {
                ...
                var width;
                if (where == "left" || where == "right") {
                    width = (settings.getNumber("state/panels/@width-" + where)
                            || panel.width || WIDTH) + CURWIDTH;
                } else {
                    width = (settings.getNumber("state/panels/@width-" + where)
                            || panel.height || WIDTH) + CURWIDTH;
                }
                ...
                if (!bar.visible) {
                    if (panels.areas[panel.where].activePanel == name) {
                        ...
                        if (where == 'left' || where == 'right') {
                            ...
                            column.setHeight(column.width + CURWIDTH);
                        }
                        activate(name, true);
                    } else {
                        if (where == 'left' || where == 'right') {
                ...
                if (hideBar) {
                    setTimeout(function(){
                        ...
                        if (!panels.areas[panel.where].activePanel) {
                            ...
                            if (panel.where == 'left' || panel.where == 'right') {
                                ...
                                var width = (settings.getNumber("state/panels/@width-" + panel.where)
                                        || panel.height || WIDTH) + CURWIDTH;
                                column.setAttribute("minHeight", panel.minHeight + CURWIDTH);
                                column.setHeight(width);
                                column.$int.lastChild.style.top = 0;
                            }
