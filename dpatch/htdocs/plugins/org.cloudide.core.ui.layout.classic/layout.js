define(function(require, exports, module) {
    main.consumes = [
        "Plugin", "layout.preload", "app", "ui", "dialog.alert", "settings",
    ...
    function main(options, imports, register) {
        ...
        function findParent(obj, where) {
            ...
            else if (obj.name == "area-bottom")
                return plugin.getElement("colBottom");
            else if (obj.name == "area-top")
                return plugin.getElement("colBottom");
        ...
        function setBaseLayout(type) {
            if (type == "sublime") {
                ...
                settings.set("user/openfiles/@show", app.local);
