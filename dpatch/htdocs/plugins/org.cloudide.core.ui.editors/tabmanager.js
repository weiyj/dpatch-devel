define(function(require, module, exports) {
    main.consumes = [
        ...
        "Tab", "editors", "Pane", "watcher", "app", "dialog.alert", 
        "focusManager", "utils"
    ];
    ...
    function main(options, imports, register) {
        ...
        function updateTitle(tab) {
            document.title = tab && settings.getBool("user/tabs/@title") && tab.title
                ...
                : app.projectName + " - "  + ideProviderName;
        }
        
        var lastCorner;
        function setCornerPadding(){
            if (!collapsedMenu || app.local) return;
        ...
        function findTab(path) {
            return tabs[PREFIX + path] || tabs[utils.normalizePath(path)];
        }
        ...
        function open(options, callback) {
            ...
            var path = options.path = utils.normalizePath(options.path);
