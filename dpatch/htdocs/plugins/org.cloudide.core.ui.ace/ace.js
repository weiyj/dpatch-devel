define(function(require, exports, module) {
    ...
    main.consumes = [
        ...
        "settings", "app", "preferences", "ui", "tabManager", "layout", "utils",
        "threewaymerge", "preferences.project"
    ];
    main.provides = ["ace"];
    return main;
    ...
    function main(options, imports, register) {
        ...
        config.setDefaultValue("session", "newLineMode", "unix");
        config.setDefaultValue("session", "tabSize", 8);
        ...
        var aceSettings = [
            ...
            // Per document
            ["tabSize",               "8",      NUMBER, "tabsize", 8],
            ["useSoftTabs",           "false",  BOOL,   "softtabs"],
        ...
        handle.on("load", function(){
            ...
            function updateSettings(e, list, prefix) {
                ...
                utils.extend(lastSettings, options);
            }
